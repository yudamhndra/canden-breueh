                    ...
                    <div className="lg:col-span-1">
                        <div className="mb-6">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex items-center text-slate-300 text-sm">
                                    <FaWhatsapp className="w-4 h-4 mr-3 text-green-400 flex-shrink-0" />
                                    <a
                                        href="https://wa.me/6282272237742"
                                        target="_blank"
                                        rel="noopener"
                                        aria-label="Chat WhatsApp Bang Daus"
                                        className="hover:text-green-400"
                                    >
                                        +62 822-7223-7742 (Bang Daus)
                                    </a>
                                </div>
                            </div>
                        </div>
